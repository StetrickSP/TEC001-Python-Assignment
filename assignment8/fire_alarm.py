...
class Building:
    ...
    def fire_alarm(self):
        print("\nFIRE ALARM! All elevators are moving to the bottom floor!")
        elevator_count = 0
        for elevator in self.elevators:
            print(f"Elavator {elevator_count} is moving down now.")
            elevator.go_to_floor(self.bottom)
            elevator_count += 1
        print("\nAll elevators have moved down to the bottom floor!")
